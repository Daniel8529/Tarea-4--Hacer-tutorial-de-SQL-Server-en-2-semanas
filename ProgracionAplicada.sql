...
/*Debe modificar el ejercicio 83, numero 2 en el insert*/
...
1- Elimine la tabla, si existe, créela y cargue un registro:*/
 ...
 insert into empleados(apellido,nombre) values ('Maria','Teresa');

 --2- Agregue el campo "sueldo", de tipo decimal(5,2).
  insert into empleados(apellido,nombre) values ('Dolores','Pedro');
   alter table empleados
